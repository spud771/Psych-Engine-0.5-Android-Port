...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Psych Engine modders'],
			['Scapemuffins',		    'scape',		    'this is just a test lolol',	 'https://youtube.com/channel/UCxG1JaGAUdNlrzKeJQ8oa0g',	    'F73838'],
			['Spud',		        'spud',		    'test',	                 'https://youtube.com/channel/UCt1VfHDVyo_VjOIaXu4V-EA',	    '261EA9'],		
			['Smileye',               'eye',            'test',                    'https://youtube.com/channel/UChHPE-D2xIRlQSfIs1f68QA',           '53E52C'],				
			[''],
